...
const Marquee: React.FC = () => {
  return (
    <div className="marquee relative flex overflow-x-hidden w-100 md:w-200 before:absolute before:content-[''] before:top-0 before:bottom-0 before:left-0 before:z-10 before:w-[20%] before:bg-linear-to-r before:from-gray-100 before:to-transparent after:absolute after:content-[''] after:top-0 after:bottom-0 after:right-0 after:w-[20%] after:z-10 after:bg-linear-to-l after:from-gray-100 after:to-transparent">
